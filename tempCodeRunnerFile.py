...
while True:
    ...
    cv2.putText(frame, f"Gender: {gender}", (bbox[0], bbox[1] - 50), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.putText(frame, f"Emotion: {emotion_label}", (bbox[0], bbox[1] - 90), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2, cv2.LINE_AA)
